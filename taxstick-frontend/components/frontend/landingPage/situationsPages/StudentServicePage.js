            ...
            <div className='relative z-20'>
                ...
                <div className='lg:flex justify-between gap-10'>
                    ...
                    <div className='relative z-20 md:w-1/2 flex md:justify-end justify-center my-[5%]'>
                        ...
                        <Image className=' right-28 w-[300px] h-[300px] lg:w-[450px] lg:h-[475px] rounded-[55px]' src={situationPage?.section_2_image} style={{objectFit:'cover',objectPosition: '50% 0%'}} alt="" />
                    </div>
                    ...
                    <div>
                        <Image className='lg:block hidden landing-page-card-trasition absolute -top-32 left-0' style={{ zIndex: '-1' }} src="/codecayonImage/shed4.png" alt="" />
                    </div>
                </div>
            </div>
            <div className='relative my-[5%]'>
                ...
                <div className='lg:flex justify-between gap-10'>
                    ...
                    <div className='relative md:w-1/2 z-20 flex md:justify-start justify-center my-10'>
                        ...
                        <Image className=' right-28 w-[300px] h-[300px] lg:w-[450px] lg:h-[475px] rounded-[55px]' src={situationPage?.section_3_image} style={{objectFit:'cover',objectPosition: '50% 0%'}} alt="" />
                    </div>
                    <div>
                        <Image className='lg:block hidden landing-page-card-trasition absolute -bottom-10 right-0' style={{ zIndex: '-1' }} src="/codecayonImage/shed4.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
