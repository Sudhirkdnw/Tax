                ...
                <div className='container flex justify-center'>
                    <div className='lg:flex justify-between items-center gap-4 md:p-[5%]'>
                        ...
                        <div className='relative h-[300px] w-[300px] md:h-[500px] md:w-[500px] mx-auto flex justify-center items-center'>
                            <Image className='h-[300px] w-[300px] md:h-[500px] md:w-[500px] rounded-full subBanner' src={situationPage?.hero_section_image ?? ''} alt="" />
                            <Image className='hidden md:block h-[250px] w-[] absolute top-1 -right-[20px] rounded' src='/codecayonImage/imageTop.png' alt="" />
                            <Image className='hidden md:block h-[250px] w-[]  absolute bottom-2 -left-6  rounded' src='/codecayonImage/imageBtm.png' alt="" />
                        </div>
                        {/* </div> */}
                    </div>
                </div>
