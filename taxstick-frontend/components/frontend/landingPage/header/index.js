            ...
            <div className='relative lg:h-[600px] 2xl:h-[800px] hero hero-section z-10 w-full main-header flex justify-center '>
                <div className='grid grid-cols-1 lg:grid-cols-2 site_container extra_small'>
                    <div className='h-[300px] lg:h-full hero-section-div-weight'>
                        <Image className='hidden lg:block lg:absolute lg:left-0 h-[300px]' src="/codecayonImage/ellipse.png" alt="" />
                    ...
                    <div className='relative h-[400px] lg:h-full hero-section-div-weight flex justify-center '>
                        <Image className='absolute left-[10%] md:left-[15%] lg:left-10  top-[20%] z-20 hero-section-banner-image hero-section-banner-image-object' src={`${banneerOne}`} alt="" />
                        <Image className='hidden 
                         hero-section-small-banner-image hero-section-banner-image-object' src={`${banneerOne}`} alt="" />

                        <Image className='absolute top-[5%] z-10 hero-section-banner-image' src='/codecayonImage/rectangle1.png' alt="" />

                        <Image className='absolute top-[10%] right-[10%] md:right-[20%] lg:right-10   z-20 hero-section-banner-image hero-section-banner-image-object' src={`${banneerTwo}`} alt="" />

                        <Image className='hidden lg:block absolute z-10 bottom-[20%] h-[100px] right-0' src="/codecayonImage/vector1.png" alt="" />
                    </div>
                </div>
            </div>
        </>
