        ...
        <div className='container hero_font_family '>
            ...
            <div className='flex justify-center my-[5%]'>
                <div className='lg:grid lg:grid-cols-2 gap-4'>
                    ...
                    <Image className='bg-gray-100 shadow-xl rounded md:h-[400px] ' src="/codecayonImage/cry.png" alt="" />
                </div>
            </div>
            ...
            <div className='flex justify-center items-center py-[5%]'>
                <div className='lg:grid lg:grid-cols-2 gap-4'>
                    {/* section related image */}
                    <Image className='bg-gray-100 shadow-xl rounded md:h-[400px]' src="/codecayonImage/goal.png" alt="" />
                    {/* about section data */}
                    <div className='flex justify-center items-center my-[5%]'>
