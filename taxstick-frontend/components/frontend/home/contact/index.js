            ...
            <div className='container relative'>
                <div className='lg:flex gap-3 '>
                    ...
                    <div className='relative flex justify-center w-1/2'>
                        <Image className='hidden lg:block absolute z-20 w-[500px] h-[500px]' src='/codecayonImage/contact.png' alt='Contact illustration' />
                        <Image className='hidden lg:block absolute z-10 h-[100px] -left-10 xl:left-[5%] bottom-[25%] ' src='/codecayonImage/vector1.png' alt='' />
                    </div>
                    {/* section header data */}
                ...
                <Image className='hidden lg:block absolute z-10 -right-8 lg:-right-[3%] -top-10 ' src='/codecayonImage/triangle.png' alt='None' />
            </div>
        </div>
    );
};
