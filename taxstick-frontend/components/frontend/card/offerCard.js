...
const OfferCard = ({ offerCards }) => {
    ...
    return (
        <div className='w-[300px] h-[450px] lg:w-[330px] mx-auto my-4 shadow-lg  rounded bg-white'>
            {/* upper style */}
            <div >
                <Image src={offerCards?.logo ?? "/codecayonImage/card1.png"} alt={offerCards?.title ?? "Offer Card Image"} className='h-[200px] w-full' style={{ objectFit: 'cover', objectPosition: '50% 0%' }} />
            </div>
            {/* inner style */}
