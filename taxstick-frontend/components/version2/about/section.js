...
const Section = ({aboutContent}) => {
    ...
    return (
        <>
            ...
            <Image src="/v2/v1.png" alt="taxstick" className='w-[375.56px] h-[390.12px] lg:block hidden -mt-40 right-0 mr-36 absolute'/>
                        ...
                        gallery?.map((item, i) => (
                            ...
                            >
                                ...
                                <FrontSide style={{ padding:'0' }}>
                                    <div className=''>
                                        <Image className='h-[320px] w-[320px] object-cover' src={item?.image ?? ""} alt="taxstick" />
