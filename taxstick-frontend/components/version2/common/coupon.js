...
const Coupon = ({cData, serviceData}) => {
    ...
    useEffect(() => {
        ...
        setRefresh(null)
    }, [serviceData?.coupon_code?.end_duration, refresh,endDate,serviceData?.coupon_code?._id, serviceData?.coupon_code?.name, status, startDate,todayDate,]);
    ...
    return (
        <>
            <div className="bg-[#292828] h-[380px] -mt-10">
                <Image src="/v2/v2.png" alt="taxstick" className='w-[274px] h-[285px] lg:block hidden ml-24 pt-10'/>
                ...
                <Image src="/v2/v2.png" alt="taxstick"
