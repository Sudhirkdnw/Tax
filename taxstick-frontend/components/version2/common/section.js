        ...
        <>
            <div className='lg:grid lg:grid-cols-2 pb-10'>
                <div className="relative">
                    ...
                    <div className="lg:w-[627px] w-fit lg:h-[468px] h-fit">
                        <Image className='-mt-40 lg:ml-4 rounded-md relative' src={taxSituation?.hero_section_image} alt='civilian' />
                        <Image src='/v2/v1.png' alt="taxstick" className='w-[191.33px] h-[198.75px] ml-[32rem] -mt-[9rem] lg:block hidden' />
                    </div>
                </div>
            ...
            <div className='lg:grid lg:grid-cols-2 lg:pt-8 pt-4 lg:pb-24 pb-8'>
                ...
                <div className="relative pt-10 ml-0 md:-ml-10 min-[1400px]:ml-4 lg:pl-24">
                    ...
                    <div className="xl:w-[627px] w-fit lg:h-[468px] h-fit">
                        <Image className='-mt-40 rounded-md relative' src={taxSituation?.section_2_image} alt='civilian' />
                        <Image src="/v2/v1.png" alt="taxstick" className='w-[191.33px] h-[198.75px] -ml-[5rem] -mt-[9rem] lg:block hidden' />
                    </div>
                </div>
            </div>
            ...
            <div className='lg:grid lg:grid-cols-2 pb-10'>
                <div className="relative">
                    <div className="w-[200px] h-[182px] bg-hover rounded-[10px] lg:-ml-2 -ml-4"></div>
                    <div className="lg:w-[627px] w-fit lg:h-[468px] h-fit">
                        <Image className='-mt-40 lg:ml-4 rounded-md relative' src={taxSituation?.section_3_image} alt='civilian' />
                        <Image src='/v2/v1.png' alt="taxstick" className='w-[191.33px] h-[198.75px] ml-[32rem] -mt-[9rem] lg:block hidden' />
                    </div>
                </div>
                <div className='pt-12 lg:pl-32 pl-4'>
