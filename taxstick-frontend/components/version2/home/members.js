            ...
            <div className="group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow">
                <div className="pt-12 pb-12">
                    <div className="flex justify-center z-0">
                        <Image src={team.image} alt="taxstick" className="rounded-full group-hover:rounded-[100px] w-[230px] h-[230px] xl:w-[270px] xl:h-[270px] transform transition duration-500 group-hover:scale-y-125" />
                    </div>
